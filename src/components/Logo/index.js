    ...
    >
      <defs>
        <filter id='prefix__editing-vr'>
          <feFlood floodColor='#fff' floodOpacity={0.7} result='c1' />
          <feFlood floodColor='#bcdbc2' floodOpacity={0.7} result='c3' />
          <feComposite
            operator='in'
            in='c1'
            in2='SourceAlpha'
